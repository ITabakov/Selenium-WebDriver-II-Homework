...
public class BoardsPage extends BaseTrelloPage {
    ...
    public void createBoard() {
        ...
        boardPage.addDefaultListsIfNotPresent();

    }
    public void goToBoard(String boardName) {
        String boardsUrl = String.format(getConfigPropertyByKey("trello.boardsPage"),
                getConfigPropertyByKey("trello.users.user.username"));
